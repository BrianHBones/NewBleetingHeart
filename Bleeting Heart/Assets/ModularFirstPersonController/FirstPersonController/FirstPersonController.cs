...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.footstepSounds = (AudioSource)EditorGUILayout.ObjectField(new GUIContent("Movement Audio Source", "Saves the player movement audio source in scene."), fpc.footstepSounds, typeof(AudioSource), true);
